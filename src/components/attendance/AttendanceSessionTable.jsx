...
export default function AttendanceSessionTable({ refreshKey }) {
  ...
  const startEdit = (session) => {
    ...
    setEditData({
      ...
      startTime,
      endTime,
      subjectId: session.subject?._id || session.subjectId || "",
      lecturerId: session.lecturer?._id || session.lecturerId || "",
              ...
              <tr key={s._id} className="border-t">
                ...
                {editId === s._id ? (
                  ...
                  <>
                    ...
                    <td className="p-2">
                      {s.lecturer?.name || s.lecturerName || ""}
                    </td>
